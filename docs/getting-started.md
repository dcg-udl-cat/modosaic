...
The repository includes a Nix flake for a CUDA-ready development shell. Configure
the Nix daemon to trust the binary caches used by the flake before running it;
